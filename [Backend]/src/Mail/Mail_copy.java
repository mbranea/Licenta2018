...
public class Mail_copy {
    ...
    private static void setContent(Session session)
    {

        Message msg = new MimeMessage(session);
        try {
            msg.setFrom(new InternetAddress( "mbranea32@gmail.com"));
            msg.setRecipient(Message.RecipientType.TO, new InternetAddress("licentamailbranea@gmail.com"));
